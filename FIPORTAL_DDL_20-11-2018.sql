...
GRANT SELECT ON TANFEETH.ACC_INFO_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.ACC_BAL_INFO_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.DEPOSIT_INFO_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.LIAB_INFO_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.SAFE_INFO_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.BAN_EXEC_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.DENY_EXEC_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.LIFT_EXEC_REQST TO FIPORTAL;
GRANT SELECT ON TANFEETH.BLOCK_EXEC_REQST TO FIPORTAL;


GRANT SELECT ON FI_GI_SUMMARY_VALIDATION TO WCR;
GRANT SELECT ON FI_BAN_SUMMARY_VALIDATION TO WCR;
GRANT SELECT ON FI_BLOCK_SUMMARY_VALIDATION TO WCR;
GRANT SELECT ON FI_DENY_SUMMARY_VALIDATION TO WCR;
GRANT SELECT ON FI_GARNISH_SUMMARY_VALIDATION TO WCR;
GRANT SELECT ON FI_LIFT_SUMMARY_VALIDATION TO WCR;

--------------------------- run as WCR --------------------
GRANT SELECT ON WCR.LOOKUP_VALUES to FIPORTAL;
CREATE INDEX WCR.LOOKUP_PAR_COD_IDNX ON LOOKUP_VALUES (LOV_PARENT, LOV_CODE);
----------------------------------- run as FIPORTAL  -----------------------------------------------
----------------------------------------------------------------------------------------------

GRANT INSERT ON FIPORTAL.WORKFLOW_TASK to TANFEETH;

GRANT SELECT, INSERT, DELETE ON FIPORTAL.ACCOUNT_INFO_RESPONSE TO WCR;
GRANT SELECT, INSERT, DELETE ON FIPORTAL.ACCOUNT_BALANCE_INFO_RESPONSE TO WCR;
GRANT SELECT, INSERT, DELETE ON FIPORTAL.DEPOSIT_INFO_RESPONSE TO WCR;
GRANT SELECT, INSERT, DELETE ON FIPORTAL.SAFE_INFO_RESPONSE TO WCR;
GRANT SELECT, INSERT, DELETE ON FIPORTAL.LIABILITY_INFO_RESPONSE TO WCR;
GRANT SELECT, INSERT, DELETE ON FIPORTAL.PRD_USR_LST TO WCR;
GRANT SELECT, INSERT, DELETE ON FIPORTAL.PRODUCT_SHARE TO WCR;
GRANT SELECT, INSERT, DELETE ON ACCOUNT_INFO_RESERVE TO WCR;
GRANT SELECT, INSERT, DELETE ON BALANCE_INFO_RESERVE TO WCR;
GRANT SELECT, UPDATE ON WORKFLOW_TASK TO WCR;

GRANT SELECT ON FIPORTAL.ACCOUNT_INFO_RESPONSE_ID TO WCR;
GRANT SELECT ON FIPORTAL.ACCOUNT_BAL_INFO_RESPONSE_ID TO WCR;
GRANT SELECT ON FIPORTAL.DEPOSIT_INFO_RESPONSE_ID TO WCR;
GRANT SELECT ON FIPORTAL.LIABILITY_INFO_RESPONSE_ID TO WCR;
GRANT SELECT ON FIPORTAL.SAFE_INFO_RESPONSE_ID TO WCR;

GRANT SELECT ON FIPORTAL.PRD_USR_LST_SEQ TO WCR;
GRANT SELECT ON FIPORTAL.PRD_SHRS_SEQ TO WCR;
...
ALTER TABLE FIPORTAL.WORKFLOW_TASK ADD (PHASH VARCHAR2(50) );
ALTER TABLE FIPORTAL.WORKFLOW_TASK RENAME  COLUMN  PHASH to TANFEETH_STATUS;

ALTER TABLE FIPORTAL.WORKFLOW_TASK MODIFY (SUB_STATUS_ID DEFAULT 0);

CREATE INDEX WF_TASK_MSGID_ID ON WORKFLOW_TASK (MSGUID, ID);
								    

CREATE INDEX FIPORTAL.WORKFLOW_TASK_QUEUE_INDX ON WORKFLOW_TASK (BUS_SRVC_CD,FI_ID, STATUS_ID);
CREATE INDEX FIPORTAL.WORKFLOW_TASK_INBOX_INDX ON WORKFLOW_TASK (BUS_SRVC_CD,FI_ID, STATUS_ID,ASSIGNED_TO);
...
ALTER TABLE FIPORTAL.DEPOSIT_INFO_RESPONSE MODIFY (DEPOSIT_BALANCE DECIMAL(38,5) );
								    
ALTER TABLE FIPORTAL.ACCOUNT_BALANCE_INFO_RESPONSE MODIFY (AVAILABLE_BALANCE DECIMAL(38,3));
ALTER TABLE FIPORTAL.ACCOUNT_BALANCE_INFO_RESPONSE MODIFY (TOTAL_BALANCE DECIMAL(38,5));

ALTER TABLE FIPORTAL.LIABILITY_INFO_RESPONSE MODIFY (INSTALLMENT_AMOUNT DECIMAL(38,3));
ALTER TABLE FIPORTAL.LIABILITY_INFO_RESPONSE MODIFY (TOTAL_LIABILITY_AMOUNT DECIMAL(38,3));
ALTER TABLE FIPORTAL.LIABILITY_INFO_RESPONSE MODIFY (REMAINING_LIABILITY DECIMAL(38,3));
